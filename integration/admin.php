        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12 bg-body-tertiary border p-4">
                    <h2 class="text-center">BackOffice - Administrateur</h2>
                </div>
            </div>

            <div class="bg-body-tertiary border mt-5 p-5 row d-flex flex-column align-items-center justify-content-center">

                <?php include 'admin_card.php'; ?>
                <?php include 'admin_card.php'; ?>
